# Generated by Django 3.2.15 on 2022-10-10 17:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text_preview', models.CharField(max_length=90)),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('is_seen', models.BooleanField(default=False)),
                ('post', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='nofity_post', to='post.post')),
